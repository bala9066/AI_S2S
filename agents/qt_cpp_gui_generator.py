"""
Qt C++ GUI Generator for Hardware Pipeline.
...
class QtCppGuiGenerator:
    ...
    def generate(
        ...
        return {
            f"qt_gui/{safe}.pro":          self._pro(safe, project_name),
            "qt_gui/main.cpp":             self._main_cpp(safe, project_name),
            "qt_gui/MainWindow.h":         self._mainwindow_h(project_name),
            "qt_gui/MainWindow.cpp":       self._mainwindow_cpp(project_name, design_type),
    ...
    def _pro(self, safe: str, project_name: str) -> str:
        return f"""\
...
{{
    ...
    MainWindow w;
    w.setWindowTitle("{project_name} — Hardware Pipeline v2");
    w.resize(1280, 800);
    w.show();
...
"""
    ...
    def _mainwindow_cpp(self, project_name: str, design_type: str) -> str:
        return f"""\
#include "MainWindow.h"
...
<ui version="4.0">
 ...
 <widget class="QMainWindow" name="MainWindow">
  ...
  <property name="windowTitle">
   <string>{project_name} — Hardware Pipeline v2</string>
  </property>
